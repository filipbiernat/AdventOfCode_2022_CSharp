...
namespace AdventOfCode2022.Day4
{
    public class Day4A : IDay
    {
        public void Run()
        {
            ...
            int output = input
                .Select(pairOfAssignments => pairOfAssignments
                    ...
                    .OrderBy(assignment => assignment.GetLength()))
                .Count(orderedPairOfAssignments => orderedPairOfAssignments
                    .Last()
                    .Contains(orderedPairOfAssignments.First()));
        ...
        private class Assignment
        {
            ...
            public int GetLength() => HighestSection - LowestSection + 1;
            public bool Contains(Assignment other) => HighestSection >= other.HighestSection && LowestSection <= other.LowestSection;
        }
    }
}
